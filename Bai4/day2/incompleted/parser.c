...
void compileBlock(void)
{
  ...
  if (lookAhead->tokenType == KW_CONST)
  {
    ...
    do
    {
      ...
      constObject->constAttrs->value = value;
...
void compileFuncDecl(void)
{
  ...
  Object *functionObject = createFunctionObject(currentToken->string);
...
void compileProcDecl(void)
{
  ...
  Object *procedureObject = createProcedureObject(currentToken->string);
...
Type *compileType(void)
{
  ...
  case KW_ARRAY:
    ...
    Type *elemenType = compileType();
    type = makeArrayType(arraySize, elemenType);
    break;
  case TK_IDENT:
    eat(TK_IDENT);
...
void compileParam(void)
{
  ...
  case TK_IDENT:
    ...
    parameterObject->paramAttrs->type = type;
